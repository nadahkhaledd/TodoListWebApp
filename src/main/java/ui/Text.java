...
public class Text {
    public ArrayList<String> menuOptions = new ArrayList<>(
            Arrays.asList("1- Add item ", "2- Update item ", "3- Delete item", "4- Show All items",
                    ...
                    "7- Add item to a category", "8- Add item to a favorite", "9- show favorites","10- Clear Screen", "11- Update Your Name","12- Log out","13- Exit","Type /back any time to go back to start menu!"));
